...
<template>
  <div class="container">
    <header class="p-5 mb-4 mt-4 bg-light rounded-3">
      ...
      <p>
        Voce possui {{ getTarefasPendentes().length }} tarefas pedentes
      </p>
    </header>
    <form @submit.prevent="cadastraTarefa">
      <div class="row">
        <div class="col">
          <input :value="estado.tarefaTemp" @change="evento => estado.tarefaTemp = evento.target.value" required class="form-control" type="text"
